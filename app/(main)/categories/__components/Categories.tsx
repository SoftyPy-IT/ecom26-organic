...
export const categories = [
  ...
  },
  {
    id: 5,
    name: 'Fruits',
    image: 'https://freebw.com/templates/oragnive-v1/images/bg-item-05.jpg',
    items: 10,
  },
  {
    id: 6,
    name: 'Vegetables',
    image: 'https://freebw.com/templates/oragnive-v1/images/bg-item-06.jpg',
    items: 15,
  },
  {
    id: 7,
    name: 'Fruit Juice',
    image: 'https://freebw.com/templates/oragnive-v1/images/bg-item-07.jpg',
    items: 20,
  },
  {
    id: 8,
    name: 'Dried',
    image: 'https://freebw.com/templates/oragnive-v1/images/bg-item-08.jpg',
    items: 25,
  },
  {
    id: 9,
    name: 'Fruits',
    image: 'https://freebw.com/templates/oragnive-v1/images/bg-item-09.jpg',
    items: 10,
  },
  {
    id: 10,
