  ...
  return (
    <div className="group border border-gray-300 hover:border-[#81b03f] transition-all duration-300 p-3 bg-white">
      <div className="flex flex-col items-center space-y-3">
        ...
        {/* Title */}
        <h3 className="text-lg font-bold">{payload?.name}</h3>
        ...
        <div className="relative h-8 flex items-center justify-center w-full">
          ...
          <div className="absolute flex gap-3 opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
            <Link href={`/shop/${payload?._id}`}>
              <button
                title="view"
                className="p-2 bg-gray-100 rounded-full hover:bg-[#81b03f] hover:text-white transition"
              >
                <Search size={18} />
              </button>
            </Link>
            <button
              ...
              className="p-2 bg-gray-100 rounded-full hover:bg-red-500 hover:text-white transition"
            >
              <Heart size={18} />
            </button>
            <button
