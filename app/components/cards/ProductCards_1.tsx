...
export default function ProductCards_1({ payload }: ProductCardsProps) {
  ...
  return (
    <div className="group relative flex flex-col bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg hover:shadow-[#81b03f]/60 transition-all duration-300">
      {/* Image Container */}
